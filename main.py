...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/Kalvinpv73") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/txtuploder") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/txtuploder")                              
                ],           
            ]
      )
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[🇰 🇦 🇱 🇻 🇮 🇳 ](https://t.me/Tushar0125)"
    if raw_text3 == '1':
        CR = '[🇰 🇦 🇱 🇻 🇮 🇳 ](https://t.me/Tushar0125)'
    elif raw_text3:
        try:
